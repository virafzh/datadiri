...
<head>
    ...
    <style>
        ...
        .hero {
            background-image: url(img/brownbg.jpeg);
            padding: 80px 0;
        }
    ...
    <div class="hero">
        <div class="header text-center text-white">
            <div class="hero-tittle">
                <h1>ZHEVIRA ANIF FAUZIAH</h1>
                <h2>SMKN 1 KOTA BEKASI</h2>
            </div>
        </div>
    </div>
    <div class="content">
        <div class="dashboard-section">
            ...
            <p>I will tell you a little about me because I have shown it on the home page</p>
            <!-- Tambahkan konten dashboard lainnya di sini -->
            <img src="{{ asset('img/programmer.jpeg') }}" alt="hobby 1" class="hobby-image">
            <img src="{{ asset('img/designer.jpeg') }}" alt="hobby 1" class="hobby-image">

         <div class="dashboard-section">
        <h2>Recent Activities</h2>
        <p>Here there are many html tags</p>
        <!-- Tambahkan daftar aktivitas terbaru di sini -->
        <table class="ws-table-all"border="1">
            <tbody>
                <tr>
                    <th style="width:25%">Tag HTML</th>
                    <th>Description</th>
                </tr>
                <tr>
                    <td>&lt;!--...--&gt;</td>
                ...
                <tr>
                    <td>&lt;dir&gt;</td>
                    <td><span class="deprecated">Not supported in HTML5. &lt;ul&gt; instead.<br></span>Defines a directory list</td>
                </tr>
                <tr>
                    <td>&lt;div&gt;</td>
